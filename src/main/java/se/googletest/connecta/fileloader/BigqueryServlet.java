package se.googletest.connecta.fileloader;
...
import se.googletest.connecta.fileloader.Configuration.Column;
  ...
  private Bigquery getBigquery() {
    if (bigquery == null) {
      AppIdentityCredential credential =
          new AppIdentityCredential.Builder(Arrays.asList(Constants.BQ_SCOPE)).build();
